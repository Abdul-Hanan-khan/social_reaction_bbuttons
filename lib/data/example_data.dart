...
final defaultInitialReaction = Reaction<String>(
  ...
  icon: Row(
    children: [
      Icon(Icons.thumb_up_off_alt_outlined,color: Colors.grey),
      SizedBox(width: 8,),
      Text('Like',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500,fontSize: 17),)
    ],
  ),
);
